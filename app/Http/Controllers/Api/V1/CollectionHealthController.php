...
class CollectionHealthController extends Controller
{
     ...
     *                 @OA\Property(property="from", type="string", format="date-time", example="2026-09-01T09:01:00Z"),
     *                 @OA\Property(property="to", type="string", format="date-time", example="2026-09-01T10:01:00Z"),
     *                 @OA\Property(
