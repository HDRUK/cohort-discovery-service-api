...
class OmopController extends Controller
{
    ...
    public function searchConcepts(Request $request, ActivityLogger $activityLogger, NLPConceptExtractor $extractor): JsonResponse
    {
        try {
            ...
            $nlp = $extractor->searchConcepts([
                ...
                'use_stats_ordering'    => $useStatsInOrdering,
                'page'                  => $page,
                'per_page'              => $perPage,
