...
class CollectionTaskHistoryController extends Controller
{
     ...
     *                 @OA\Property(property="from", type="string", format="date-time", example="2026-09-01T10:01:00Z"),
     *                 @OA\Property(property="to", type="string", format="date-time", example="2026-09-02T10:01:00Z"),
     *                 @OA\Property(
     ...
     *                                 description="The query this task ran. Null if the query has since been deleted.",
